# Resize remaining vegetable detail photos to max 820px wide.
...
$ids = @(
  'artisjok', 'bleekselderij', 'bleekselderij_blad', 'erwtensoep_erwt', 'kardoen',
  'knolraap', 'knolselerij', 'knolvenkel', 'lavendel_bloei', 'lente_ui',
  'lindenbloesem', 'meiraap', 'patisson_geel', 'phacelia_tanacetifolia', 'physalis',
  'raap', 'raapsteeltjes', 'raps_kool', 'stengelselderij', 'topinambur',
  'tuinmelde', 'venkel', 'waterkers', 'winterpostelein'
)
