# Resize batch-3 vegetable detail photos to max 820px wide.
...
$ids = @(
  'prei', 'pruimtomaat', 'raapkool', 'raapstelen', 'rabarber', 'radijs',
  'rammenas', 'rode_biet', 'rode_savooi', 'rode_ui', 'rodekool', 'romanesco',
  'rucola', 'savooiekool', 'scheve_ui', 'schorseneer', 'serrano_peper', 'sjalot',
  'sla', 'snackkomkommer', 'snijbiet', 'snijbonen', 'snijboon_geel', 'snoeptomaat',
  'sojaboon', 'spinazie', 'spitskool', 'spruitkool', 'spruitkool_rood', 'sugarsnaps'
)
